...
export const MuiAccordion = () => {
    ...
    <Accordion expanded={expanded === 'panel1'} onChange={(event, isExpanded) => handleChange(isExpanded, 'panel1')}>
        ...
        <AccordionDetails>
            <Typography>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt unde ut esse. Laborum porro vel minima enim, nobis eaque iure ratione deleniti consequatur a molestias. Consequuntur ab cum omnis nihil.
            </Typography>
        </AccordionDetails>
    </Accordion>
